...
import 'envelope_dialog.dart';
import 'envelope_field_cell.dart';

class ApplyFailedDialog extends StatelessWidget {
  final TaskCenterApplyEntities item;

  static final calculateTotal = GenTaskCenterController.to.calculateTotal;
  static final calculateTotalWith =
      GenTaskCenterController.to.calculateTotalWith;
    ...
    if (item.deposit != null) {
      ...
      _list.add(
        EnvelopeFieldCell(
          ...
          percent: calculateTotal(item.depositFinish!, item.deposit!),
    ...
    if (item.dml != null) {
      ...
      _list.add(
        EnvelopeFieldCell(
          ...
          percent: calculateTotal(item.dmlFinish!, item.dml!),
        ...
        child: GestureDetector(
          ...
          child: Container(
            ...
            decoration: BoxDecoration(
              gradient: AoneAppTheme.appTheme.tcCellBottomBtnGradient,
            ...
            child: Text(
              '立即去完成',
              style: TextStyle(
                color: AoneAppTheme.appTheme.tcCellBottomBtnTitleColor,
              ),
            ),
          ),
        ),
