...
class ProgressDetailDialog extends StatelessWidget {
            ...
            child: Column(
              ...
              children: [
                ...
                EnvelopeFieldCell(
                  label: '任务说明',
                  content: taskInfo +
                      '\n${detail.gameTagName == '全部' ? '' : '【此项任务指定需游戏：${detail.gameTagName}】'}',
                ),
                ..._conditions(),
                const SizedBox(
                  height: 20,
  ...
  List<Widget> _conditions() {
    ...
    if (_progress.deposit != null) {
      ...
      _list.add(EnvelopeFieldCell(
        ...
        percent: calculateTotal(_progress.depositFinish!, _progress.deposit!),
        percentStr:
  ...
  Widget _conditionField(
    ...
    return EnvelopeFieldCell(
      ...
      percent: calculateTotal(finish, condition),
