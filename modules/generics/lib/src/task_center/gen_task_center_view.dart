...
import 'widegts/no_data_for_task_cneter.dart';
import 'widegts/progress_card.dart';

class GenTaskCenterView extends GetView<GenTaskCenterController> {
  const GenTaskCenterView({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    return GetBuilder<GenTaskCenterController>(builder: (_) {
          ...
          return Center(
            child: Container(
              ...
              decoration: BoxDecoration(
                ...
                image: AssetImage(
                  'assets/images/activity/task_center/${isActive ? 'task_center_select_bg' : 'task_center_unselect_bg'}.png',
                ),
                fit: BoxFit.fill,
              )),
              child: Column(children: [
                ...
                Image.asset(
                  'assets/images/activity/task_center/$icon.png',
                  height: 20.w,
                  width: 20.w,
                  color: isActive
