...
import '../../tool/light_text.dart';
import '../controllers/commission_description_controller.dart';
import '../controllers/promotion_rebate_controller.dart';

class AoneCommissionDescriptionView
    extends GetView<AoneCommissionDescriptionController> {
  const AoneCommissionDescriptionView({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    final ctrl = AonePromotionRebateController.to;

    return GetBuilder<AoneCommissionDescriptionController>(builder: (_) {
      return ThemeScaffold(
        linearGradient: AoneAppTheme.appTheme.shareAppBarGradient,
        title: '佣金说明',
        body: Container(
              ...
              SizedBox(
                ...
                child: Container(
                  decoration: BoxDecoration(
                    gradient: AoneAppTheme.appTheme.shareTitleGradient ??
                    ...
                    child: Column(
                      ...
                      children: <Widget>[
                        ...
                        Container(
                          height: 46.r,
                          width: Get.width,
                          color: AoneAppTheme.appTheme.backgroundColor,
                        ...
                        Container(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              LightText.buildColorFont(
                                  '我的业绩：所有旗下会员的自营业绩总和:',
                                  AoneAppTheme.appTheme.greenTextColor ??
                                      Colors.white,
                                  12.sp),
                              SizedBox(
                                height: 5.r,
                              ...
                              LightText.buildColorFont(
                                  '自营业绩：每个会员自己的游戏有效投注额',
                                  AoneAppTheme.appTheme.textRedColor ??
                                      Colors.white,
                                  12.sp),
                              SizedBox(
                                height: 5.r,
                              ...
                              LightText.buildColorFont(
                                  ...
                                  AoneAppTheme.appTheme.blueColor ??
                                      Colors.white,
                                  12.sp),
                              SizedBox(
                                height: 15.r,
  ...
  DataColumn _tableColumn(String title, int index) {
    ...
    return DataColumn(
      ...
      child: Text(
        title,
        style: AoneAppTheme.appTheme.regularStyle,
      ),
    ));
  }
                    ...
                    controller.tabIndexQuanmintgYiIntroduce == index
                        ? Positioned(
                            ...
                            child: Container(
                              height: 2.r,
                              width: 30.r,
                              color: AoneAppTheme.appTheme.goldTextColor,
                            ),
                          )
                        : SizedBox()
                  ],
