...
class AonePromotionRebateView extends GetView<AonePromotionRebateController> {
  ...
  AonePromotionRebateView({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    return GetBuilder<AonePromotionRebateController>(builder: (_) {
          ...
          appBar: AppBar(
              ...
              flexibleSpace: Container(
                decoration: BoxDecoration(
                  gradient: AoneAppTheme.appTheme.primaryGradient,
                ),
              )),
          body: Container(
  ...
  _buildHeaderView() {
    return Container(
      height: 140.h,
      padding: EdgeInsets.only(top: 16, bottom: 10.h),
      decoration: AoneAppTheme.appTheme.shareBarDecoration ??
          BoxDecoration(color: AoneAppTheme.appTheme.shareTuiGuang),
      child: Obx(() {
        return Column(
          children: <Widget>[
            Row(
            ...
            GestureDetector(
                ...
                child: Container(
                    ...
                    height: 36,
                    width: 112,
                    decoration: AoneAppTheme.appTheme.shareBtnDecoration2 ??
                        BoxDecoration(
  ...
  _buildButtonList() {
    return Obx(() => Center(
          child: Container(
            ...
            height: 36,
            decoration: BoxDecoration(
                color: AoneAppTheme.appTheme.shareBgSelectTextColor ??
  ...
  _itemButton(String title, bool selState, int index) {
    return Container(
      ...
      width: 134,
      decoration: selState
          ? (AoneAppTheme.appTheme.shareSelectBtnDecoration ??
              BoxDecoration(
                color: stringToColor('FFFFFF'),
                borderRadius: BorderRadius.circular(30),
              ))
      ...
      child: TextButton(
        ...
        child: Text(
          ...
          style: TextStyle(
              color: selState
                  ? (AoneAppTheme.appTheme.shareSelectTextColor ??
                      stringToColor('000000'))
                  : (AoneAppTheme.appTheme.shareUnSelectTextColor ??
                      stringToColor('666666')),
              fontSize: 12,
    ...
    return Obx(() {
      return Container(
        ...
        decoration: BoxDecoration(
          ...
          color: AoneAppTheme.appTheme.themeBackgroundColor,
        ),
      ...
      return Column(
        children: <Widget>[
          ...
          Container(
            ...
            color: AoneAppTheme.appTheme.undeer_line_color,
          ),
          _item(
              '历史业绩/元',
  ...
  _buildHistorcalContentList() {
    ...
    if (count <= 0) {
      return Container(
        color: AoneAppTheme.appTheme.normalBgColor,
        alignment: Alignment.topCenter,
        padding: EdgeInsets.only(top: 51.r),
        child: Text(
          " 暂无历史业绩",
          style: TextStyle(
              color: AoneAppTheme.appTheme.normalTextColor, fontSize: 14.sp),
        ),
      );
    }
  ...
  _item(String title, String frist, String second, String third, bool isTitle) {
    return Container(
      height: 41,
      decoration: BoxDecoration(color: AoneAppTheme.appTheme.normalBgColor
          // color: Colors.red
          ),
      padding: const EdgeInsets.only(top: 7, bottom: 7),
      child: Row(
  ...
  _buildFootView() {
    return Container(
      ...
      decoration: AoneAppTheme.appTheme.shareUrlBgDecoration ??
          BoxDecoration(
                ...
                () {
                  return Expanded(
                    child: Container(
                      ...
                      child: Text(
                        controller.state.tjUrl ?? '',
                        style: TextStyle(
                          fontSize: 12,
                          color: AoneAppTheme.appTheme.shareUrlTextColor ??
                              Color(0xFFCCCCCC),
                        ),
                        maxLines: 1,
  ...
  Widget _shareItem(Tuple2 tuple2, int index) {
    return GestureDetector(
      ...
      child: Column(
        children: <Widget>[
          SizedBox(height: 50, child: Image.asset(tuple2.item1)),
          Text(
            tuple2.item2,
  ...
  _footButton() {
    return Container(
        ...
        height: 30.h,
        alignment: Alignment.center,
        decoration: AoneAppTheme.appTheme.shareBtnDecoration ??
            BoxDecoration(
                borderRadius: BorderRadius.circular(8),
                color: AoneAppTheme.appTheme.shareTuiGuang?.withOpacity(0.65)),
