...
import 'package:generics/src/common_widgets/gen_theme_scaffold.dart';
import 'package:get/get.dart';

import '../common_widgets/gen_no_data.dart';

class GenRechargeMainView extends GetView<RechargeController> {
  const GenRechargeMainView({Key? key}) : super(key: key);
