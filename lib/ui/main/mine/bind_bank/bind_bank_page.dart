          ...
          children: [
            ...
            Obx(() {
              return Visibility(
                ...
                child: Container(
                  height: state.userDraw.value.banks == null
                      ? 0
                      : 181.h * state.userDraw.value.banks!.length +
                          30 * state.userDraw.value.banks!.length,
                  margin: EdgeInsets.symmetric(horizontal: 15),
                  child: ListView(
                    children: state.userDraw.value.banks
                            ?.map((e) => buildBankItem(e))
                            .toList() ??
                        [],
