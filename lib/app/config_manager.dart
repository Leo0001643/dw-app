...
class ConfigManager {
  ...
  static const channel_zxgj = "zxgj";
...
/// leyou(9009) jsgj(9010) longmen(9011) jbp(9012) yygj(9013) zxgj(9015)
String channelName = const String.fromEnvironment('CHANNEL', defaultValue: 'zxgj');
