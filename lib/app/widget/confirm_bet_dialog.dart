...
///确认注单
class ConfirmBetDialog extends StatefulWidget{

  final GameRoomLogic logic;
  ConfirmBetDialog(this.logic, {super.key});

  @override
  State<StatefulWidget> createState() =>StateConfirmBetDialog();
}

class StateConfirmBetDialog extends State<ConfirmBetDialog> with SingleTickerProviderStateMixin{
