                  ...
                  Container(
                    ...
                    child: Column(
                      children: [
                        ...
                        Text(Intr().faxianxinbanben,style: TextStyle(fontSize: 16.sp,color: ColorX.text0917(),fontWeight: FontWeight.w700),),
                        SizedBox(height: 10.h,),
                        Text("。。。。。。。。。。。。。。。。。。。。。。。",
                          style: TextStyle(fontSize: 14.sp,color: ColorX.text5862(),),maxLines: 10,overflow: TextOverflow.ellipsis,),
                        SizedBox(height: 15.h,),
                        Row(
                          mainAxisAlignment: mask ? MainAxisAlignment.center:MainAxisAlignment.spaceAround,
                          crossAxisAlignment: CrossAxisAlignment.center,
                          children: [
                            Visibility(
                              visible: !mask,
