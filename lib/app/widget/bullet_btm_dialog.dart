...
class BulletBtmDialog extends StatefulWidget {
  final GameRoomLogic logic;

  final Function valueCallBack;

  BulletBtmDialog(this.logic,this.valueCallBack, {super.key});

  @override
  State<StatefulWidget> createState() => StateBulletBtmDialog();

}

class StateBulletBtmDialog extends State<BulletBtmDialog> with SingleTickerProviderStateMixin{
