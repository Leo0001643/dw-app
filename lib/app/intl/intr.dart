...
class Intr extends Translations{
  ...
  String get zhongjiangjieguodongxiao => "zhongjiangjieguodongxiao".tr;
  String get qingxuanzhetouzhuxm => "qingxuanzhetouzhuxm".tr;
  String get xiazhujinewk => "xiazhujinewk".tr;
  String get danmu => "danmu".tr;
  String get changqihuodong => "changqihuodong".tr;
  String get jiehzhiriqizhi => "jiehzhiriqizhi".tr;
  String get dao => "dao".tr;
  String get zanwuxiazhujilu => "zanwuxiazhujilu".tr;
  String get xuanzheleixing => "xuanzheleixing".tr;
  String get kaishixiazhu => "kaishixiazhu".tr;
  String get touzhuchenggong => "touzhuchenggong".tr;
  ...
  String get zunjingdekehu => "zunjingdekehu".tr;
  String get xitonggonggao => "xitonggonggao".tr;
  String get yibangding => "yibangding".tr;
  String get xuanzhenindemorenqianbao => "xuanzhenindemorenqianbao".tr;
  String get morenqianbaotishi1 => "morenqianbaotishi1".tr;
  ...
  String get yicizhinengfasong3tiao => "yicizhinengfasong3tiao".tr;
