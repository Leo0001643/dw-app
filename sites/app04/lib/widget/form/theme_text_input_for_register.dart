...
class ThemeTextInputForRegister extends StatefulWidget {
  final String? label;
  ...
  const ThemeTextInputForRegister({
    Key? key,
    this.label,
    this.hintText,
    this.labelWidth = 80,
  ...
  @override
  State<ThemeTextInputForRegister> createState() => _ThemeTextInputState();
}

class _ThemeTextInputState extends State<ThemeTextInputForRegister> {
  ...
  Widget build(BuildContext context) {
    return Container(
      margin: EdgeInsets.only(bottom: widget.marginBottom.h, top: 10.r),
        ...
        decoration: InputDecoration(
          prefixIcon: widget.label != null
            ...
            child: Text.rich(
              ...
              : SizedBox(),
          fillColor: isFocused
              ? const Color.fromRGBO(233, 240, 253, 1)
              : Colors.white,
          filled: true,
