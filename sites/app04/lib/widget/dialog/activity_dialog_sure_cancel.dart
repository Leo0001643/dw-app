...
class ActivityDialogSureCancel extends StatelessWidget {
        ...
        Container(
          ...
          decoration: BoxDecoration(
            image: DecorationImage(
                image: AssetImage('assets/images/activity/h09_signin_activities_that_bg.png'),
                fit: BoxFit.fill
            ),
          ),
          child: Column(
  ...
  Widget _close() {
    return GestureDetector(
      ...
      child:
      Image.asset('assets/images/activity/h09_activity_task_dialog_close.png',height: 40.r,width: 40.r,),);
  }
}
