...
import '../../general/views/loading.dart';
    ...
    return Obx(() {
      return Padding(
        padding: EdgeInsets.only(
          top:
              gamevc.progressNum != 100 ? 0 : context.mediaQueryViewPadding.top,
          bottom: gamevc.progressNum != 100
              ? 0
        ...
        InAppWebView(
          ...
          onConsoleMessage: (InAppWebViewController controller,
            ...
            if (consoleMessage.message.contains("is_fltter_bet")) {
              try {
                Map<String, dynamic> map = json.decode(consoleMessage.message);
        ...
        GestureDetector(
          ...
          child: DraggableFab(
            child: Container(
              ...
              // ),
              child: Image.asset(
                'assets/images/game_init/${AppRuntimeConfig.siteTag}_float_${gamevc.showSubView ? 'close' : 'menu'}.png',
              ),
            ),
          ...
          Positioned(
            ...
            child: Container(
              ...
              child: Column(
                children: <Widget>[
                  createTapButton(
                      'assets/images/game_init/${AppRuntimeConfig.siteTag}_float_home.png',
                      () {
                    gamevc.showSubView = false;
                    Get.back();
                  }),
                  createTapButton(
                      'assets/images/game_init/${AppRuntimeConfig.siteTag}_float_wallet.png',
                      () {
                    gamevc.showSubView = false;
