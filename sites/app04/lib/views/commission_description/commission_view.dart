                  ...
                  child: Container(
                    ...
                    child: Column(
                      ...
                      children: <Widget>[
                        ...
                        Obx(() {
                          return Container(
                            ...
                            child: DataTable(
                              ...
                              columns: [
                                _tableColumn('popularize.segment'.tr),
                                _tableColumn('popularize.performance.range'.tr),
                                _tableColumn('popularize.one.level.team'.tr),
                                _tableColumn('popularize.two.level.team'.tr),
                                _tableColumn('popularize.three.level.team'.tr),
                              ],
                              rows: controller
                        ...
                        DjImage.asset(
                          'assets/images/user/user_commission_description.png',
                          width: Get.width,
                          height: Get.width,
                        ),
                        Container(
