...
import 'package:app04/views/user/promotion_rebate/views/back_appbar.dart';
...
class PromotionRebateView extends GetView<PromotionRebateController> {
  ...
  _buildHeaderView() {
    return Container(
      ...
      decoration: const BoxDecoration(color: AppTheme.shareTuiGuang),
      child: Obx(() {
        return Column(
          children: <Widget>[
            Row(
  ...
  _footButton() {
    return Container(
        ...
        decoration: BoxDecoration(
            borderRadius: BorderRadius.circular(8),
            color: AppTheme.shareTuiGuang.withOpacity(0.65)),
