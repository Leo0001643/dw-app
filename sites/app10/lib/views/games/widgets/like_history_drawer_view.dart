...
class LikeHistoryDrawerView extends StatelessWidget {
        ...
        return Drawer(
          child: Column(
            children: [
              ...
              Expanded(
                  child: GameCategoryController.to.drawType == 0
                      ? _historyConain()
                      : _contentView())
            ],
          ),
  ...
  Widget _historyConain() {
    return GameCategoryController.to.historyList.length != 0
        ? ListView.builder(
  ...
  Widget _contentView() {
    return FavoriteLogic.to.state.favoriteList.length != 0
        ? Obx(() {
            return ListView.builder(
                ...
                itemBuilder: (ctx, index) {
                  return GestureDetector(
                    child:
                        _listItem(FavoriteLogic.to.state.favoriteList[index]),
                    onTap: () {
                      onBeforeGameInit(
                        onGameParams:
                            FavoriteLogic.to.state.favoriteList[index],
                      );
                    },
                  );
                });
            ...
            children: [
              ...
              Positioned(
                ...
                child: GestureDetector(
                  onTap: () {
                    FavoriteLogic.to
                        .removeFavorite(gameSubId: item.gameSubId!)
                        .then((value) {
                  ...
                  child: Container(
                    ...
                    child: Image.asset('assets/images/home/like_select.png'),
                  ),
                ),
              )
            ],
