...
import 'package:app10/tab/views/web_page.dart';
import 'package:app10/views/activities/person/person_page.dart';
import 'package:app10/views/collections/bindings/collections_binding.dart';
import 'package:app10/views/general/bindings/web_binding.dart';
import 'package:app10/views/general/views/customer_service_page.dart';
import 'package:app10/views/general/views/main_tabbar_view.dart';
...
import 'package:app10/views/user/promotion_rebate/bindings/promotion_rebate_binding.dart';
import 'package:get/get.dart';

import '../activities/person/bindings/person_binding.dart';
import '../collections/views/collections_view.dart';
import '../user/promotion_rebate/bindings/commission_description_binding.dart';
import '../user/promotion_rebate/views/commission_description_view.dart';
