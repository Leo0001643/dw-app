...
class DiscountApplyShow extends StatelessWidget {
  ...
  _buildListView() {
    ...
    for (int i = 0; i < _list.length - 1; i++) {
      ...
      _returnList.add(_buildItem(entity.extShowName!, entity.extShowDesc!,entity.isrequired == 1,
  ...
  _buildItem(String title, String hintText, bool isRequrid, {TextEditingController? input}) {
        ...
        children: <Widget>[
          ...
          input == controller.timeTF
              ...
              validator: FormBuilderValidators.compose([
               FormBuilderValidators.required(errorText: title + 'mustFill'.tr),
              ]),
              controller: input,
              name: '',
              autofocus: false,
              ...
              decoration: InputDecoration(
                ...
                hintText: hintText,
                hintStyle:
                    const TextStyle(color: Color(0xf5f5f5f5), fontSize: 12),
