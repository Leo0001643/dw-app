...
import '../promotion_rebate/controllers/promotion_rebate_controller.dart';
import 'controllers/modify_user_controller.dart';

class ModifyUserRebateView extends GetView<ModifyUserController> {
  ...
  ModifyUserRebateView({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    return GetBuilder<ModifyUserController>(builder: (_) {
    ...
    return Container(
      ...
      decoration: BoxDecoration(
          image: DecorationImage(
              fit: BoxFit.fill,
              image: AssetImage(
                "assets/images/user/user_math_bg.png",
              ),
