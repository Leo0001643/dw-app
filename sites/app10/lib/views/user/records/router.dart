...
import 'package:app10/views/user/records/bindings/bet_history_detail_binding.dart';
import 'package:app10/views/user/records/views/back_history_view.dart';
import 'package:app10/views/user/records/views/bet_history_detail_view.dart';
