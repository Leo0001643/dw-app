...
class AddBankView extends StatelessWidget {
  Widget build(BuildContext context) {
    ...
    return ThemeScaffold(
      title: state.isPerfectDrawInfoPage == true ?'完善取款信息':'卡包管理',
              ...
              child: Column(
                ...
                children: [
                  ...
                  TextField(
                    ...
                    readOnly: state.true_name.text.isNotEmpty == true,
                    textAlign: TextAlign.start,
                    decoration: InputDecoration(
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        child: GestureDetector(
          child: Text(
            state.isPerfectDrawInfoPage == true?'提交':'confirm.binding'.tr,
                    ...
                    GestureDetector(
                      onTap: () {
                        if (CardManagerChildLogic.to.state.bankSelect == 0) {
                          CardManagerChildLogic.to.state.bank_name.text = CardManagerChildLogic.to.state.isSearch
                              ? state.selectBankList[0]
                              : state.bankList[0];
                          CardManagerChildLogic.to.setBankValue(CardManagerChildLogic.to.state.isSearch
                              ? state.selectBankList[0]
                              : state.bankList[0]);
                        }
                        Get.back();
  ...
  Widget _buildBankPicker() {
    ...
    return CupertinoPicker(
      ...
      onSelectedItemChanged: (value) {
        ...
        CardManagerLogic.to.state.currentType = value;
        CardManagerChildLogic.to.state.bank_name.text = state.bankList[value];
      },
