...
class SigninEverydayController extends SininLogic {
  ...
  getShowGameList() {
    ...
    subChildren = HomePageController.to.state.hotAllGameItem;
  ...
  SininLabelState getSininLabel(SevenDay sevenDay) {
    switch (sevenDay.state) {
      case 0:
        {
          if (double.parse(sevenDay.extraMoney!.toString()) > 0) {
            return SininLabelState(
              labelColor: stringToColor('EC2121'),
              groundColor: stringToColor('dddddd'),
              labelText: '待签',
      ...
      case 1:
        {
          return SininLabelState(
            labelColor: stringToColor('3DC070'),
            groundColor: stringToColor('3DC070'),
            labelText: '已签',
      ...
      case 2:
        {
          if (double.parse(sevenDay.extraMoney!.toString()) > 0) {
            return SininLabelState(
              labelColor: stringToColor('EA6736'),
              groundColor: stringToColor('EA6736'),
              labelText: '已补',
      ...
      case 4: //4
        {
          if (double.parse(sevenDay.extraMoney!.toString()) > 0) {
            return SininLabelState(
              labelColor: stringToColor('848786'),
              groundColor: stringToColor('848786'),
              labelText: '补签',
              topGroundColor: stringToColor('F6E1B5'),
              toplabeldColor: stringToColor('2E2D30'),
              showType: '5',
