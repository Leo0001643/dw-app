...
class WithdrawalStateNew {
  GlobalKey<FormBuilderState> withdrawFormKey = GlobalKey<FormBuilderState>();
  ...
  RxList<BankInfos> _mbankList = RxList([]);
  RxList<BankInfos> get mbankList => _mbankList;
  set mbankList(RxList<BankInfos> value) =>
      _mbankList.value = value;
  ...
  String? get withdrawBankCard {
    if (bankInfo.id != null) {
      var bankName =
          bankInfo.type == 1 ? '${bankInfo.bankname!}尾号' : bankInfo.bankkaihu!;
