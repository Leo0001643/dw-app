...
import 'package:aone_locales/src/aone_locales_controller.dart';
...
class AoneLocale extends StatelessWidget {
  final WidgetBuilder child;
  final Locale? defaultLocale;

  const AoneLocale({Key? key, required this.child, this.defaultLocale}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return EasyLocalization(
      ...
      startLocale: defaultLocale ?? const Locale('zh', 'CN'),
